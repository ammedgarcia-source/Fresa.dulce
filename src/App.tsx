...
const PRODUCTS = [
  ...
  {id:19, name:'Paquete fresa mango',                       desc:'1 bolsa 1kg fresa + 1 bolsa 1kg mango congeladas. Envío gratis al comprar 1 paquete.',                price:220, oldPrice:null, emoji:'🍓', image: 'https://i.postimg.cc/cC3G2VfD/Gemini-Generated-Image-7f18ag7f18ag7f18.png', cat:'Fruta congelada', wa:'fresas'},
    ...
    <div className="max-w-6xl mx-auto p-4 md:p-6">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 md:p-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 relative">
            ...
            <div className="space-y-4">
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square shadow-2xl transform -rotate-2 hover:rotate-0 transition-all duration-500">
                <img src="https://i.postimg.cc/cC3G2VfD/Gemini-Generated-Image-7f18ag7f18ag7f18.png" className="w-full h-full object-cover" alt="Fruta" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
      ...
      <div className="fixed bottom-24 right-6 z-50 flex flex-col gap-3">
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-green-wa text-white p-3 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center group relative"
        ...
        <a 
          href={`https://wa.me/${WA_FRESAS}`}
          target="_blank"
          rel="noopener noreferrer"
          className="bg-blue-600 text-white p-3 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center group relative"
